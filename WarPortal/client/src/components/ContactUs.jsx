  ...
  return (
    <>
      <div class="bg-white dark:bg-black text-center m-auto  justify-center flex flex-col  align-middle">
        ...
        <button class="lg:p-4 mt-2 lg:m-10 lg:text-3xl lg:w-1/6 w-1/3 m-auto rounded-full bg-gradient-to-tr  from-yellow-500   via-red-800  to-yellow-500 p-1 text-white hover:from-red-800 hover:via-yellow-500 hover:to-red-800">
