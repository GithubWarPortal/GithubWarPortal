...
export default function Create() {
  return (
    <>
          <div class="bg-[url('/images/blue-red.jpg')] bg-center w-full bg-cover bg-opacity-30 bg-no-repeat pl-22 p-6 md:text-2xl font-zen text-lg  m-auto flex md:flex-row flex-col justify-center text-center  bg-white dark:bg-black gap-4 ">
